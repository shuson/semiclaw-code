 ...
 * Initialized during Semiclaw Code startup.
 */
 ...
 * asynchronously during Semiclaw Code startup. Use getInitializationStatus() to
 ...
 *
 * This function is called during Semiclaw Code startup. It synchronously creates
 ...
 *
 * This should be called during Semiclaw Code shutdown. Stops all running LSP servers
