...
export type GlobalConfig = {
  ...
  firstStartTime?: string // ISO timestamp when Semiclaw Code was first started on this machine
  ...
  // Semiclaw Code usage tracking
  claudeCodeFirstTokenDate?: string // ISO timestamp of the user's first Semiclaw Code OAuth token
  ...
  // Semiclaw Code hint protocol state (<claude-code-hint /> tags from CLIs/SDKs).
