...
/**
 * Resolve Semiclaw Code-specific path patterns for sandbox-runtime.
 *
 * Semiclaw Code uses special path prefixes in permission rules:
...
/**
 * Convert Semiclaw Code settings format to SandboxRuntimeConfig format
...
export function convertToSandboxRuntimeConfig(
  ...
  // This blocks settings in the original working directory (where Semiclaw Code started)
