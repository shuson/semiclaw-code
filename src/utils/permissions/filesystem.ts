...
// Always ask when Semiclaw Code tries to edit its own config files
 ...
 * This is a per-user temporary directory used by Semiclaw Code for all temp files.
 *
 ...
 * - MCP CLI state files (managed internally by Semiclaw Code)
